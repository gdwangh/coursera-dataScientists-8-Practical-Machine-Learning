...
This document is project course of the course "Practical Machine Learning". 
...
The goal of this project: use data from accelerometers on the belt, forearm, arm, and dumbell of 6 participants, who were asked to perform barbell lifts correctly and incorrectly in 5 different ways, to perform the classification model for 5 different ways. 
...
```
So, the out of sample errors is expected to be `r (postResample(pred, valid_classe))[1]`
